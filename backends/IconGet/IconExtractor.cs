...
{
    public class No256Icon : Exception
    {
        public No256Icon(string message) : base(message) { }
    }
    ...
    public class ErrorLoad : Exception
    {
        public ErrorLoad(string message) : base(message) { }
    }
    public class UnkownError : Exception
    {
        public UnkownError(string message) : base(message) { }
    }
    ...
    public class Worker // 类定义
    {
...

        {
            try
            {
                ...
                if (icon256 == null)
                    throw new No256Icon("No 256x256 icon found!");
                ...
                if (imageData == null)
                {
                    throw new ErrorLoad("Fail to load icon data");
                }
                return imageData;
